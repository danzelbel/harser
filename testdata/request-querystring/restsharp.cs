...
public sealed class Foo
{
    ...
    public async Task Harser()
    {
        ...
        req.AddQueryParameter("datetime", "11:59:59pm 12/31/9999");
        req.AddQueryParameter("text", "Lorem ipsum dolor");
        req.AddQueryParameter("doublequotes", "\"hello there");
        req.AddQueryParameter("path", @"c:\temp");
